...
f = open('eval-lpwc-dt/graphsage/results/03_eval-graphsage-literals.txt', 'w')
sys.stdout = f
...
class Model(torch.nn.Module):
    def __init__(self, hidden_channels):
        super().__init__()
        self.paper_lin = torch.nn.Linear(129, hidden_channels)
        self.method_lin = torch.nn.Linear(130, hidden_channels)
        self.dataset_lin = torch.nn.Linear(132, hidden_channels)
