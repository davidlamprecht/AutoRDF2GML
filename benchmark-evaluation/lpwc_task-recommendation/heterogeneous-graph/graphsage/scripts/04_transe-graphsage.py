...
f = open('eval-lpwc-dt/graphsage/results/04_eval-graphsage-transe.txt', 'w')
sys.stdout = f
...
#load data
paper_csv = "lpwc/idx/nodes-transe/paper_transe.csv"
method_csv = "lpwc/idx/nodes-transe/method_transe.csv"
dataset_csv = "lpwc/idx/nodes-transe/dataset_transe.csv"
task_csv = "lpwc/idx/nodes-transe/task_transe.csv"
...
class Model(torch.nn.Module):
    def __init__(self, hidden_channels):
        super().__init__()
        self.paper_lin = torch.nn.Linear(128, hidden_channels)
        self.method_lin = torch.nn.Linear(128, hidden_channels)
        self.dataset_lin = torch.nn.Linear(128, hidden_channels)
        self.task_lin = torch.nn.Linear(128, hidden_channels)
