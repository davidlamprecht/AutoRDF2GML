...
f = open('eval-lpwc-dt/graphsage/results/06_eval-graphsage-combined-concatenated..txt', 'w')
sys.stdout = f
...
class Model(torch.nn.Module):
    def __init__(self, hidden_channels):
        super().__init__()
        self.paper_lin = torch.nn.Linear(257, hidden_channels)
        self.method_lin = torch.nn.Linear(258, hidden_channels)
