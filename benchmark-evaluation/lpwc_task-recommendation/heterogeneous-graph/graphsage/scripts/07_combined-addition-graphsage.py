...
f = open('eval-lpwc-dt/graphsage/results/07_eval-graphsage-combined-addition..txt', 'w')
sys.stdout = f
...
paper_tensor = torch.add(paper_tensor_literal, paper_tensor_embedding)
method_tensor = torch.add(method_tensor_literal, method_tensor_embedding)
dataset_tensor = torch.add(dataset_tensor_literal, dataset_tensor_embedding)
task_tensor = torch.add(task_tensor_literal, task_tensor_embedding)
