...
f = open('eval-lpwc-dt/graphsage/results/09_eval-graphsage-combined-average.txt', 'w')
sys.stdout = f
...
paper_tensor = (paper_tensor_literal + paper_tensor_embedding) / 2
method_tensor = (method_tensor_literal + method_tensor_embedding) / 2
dataset_tensor = (dataset_tensor_literal + dataset_tensor_embedding) / 2
task_tensor = (task_tensor_literal + task_tensor_embedding) / 2
