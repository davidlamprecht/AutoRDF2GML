...
f = open('eval-lpwc-dt/graphsage/results/10_eval-graphsage-combined-nn.txt', 'w')
sys.stdout = f
...
paper_tensor = combinator(paper_tensor_literal, paper_tensor_embedding)
method_tensor = combinator(method_tensor_literal, method_tensor_embedding)
dataset_tensor = combinator(dataset_tensor_literal, dataset_tensor_embedding)
task_tensor = combinator(task_tensor_literal, task_tensor_embedding)
