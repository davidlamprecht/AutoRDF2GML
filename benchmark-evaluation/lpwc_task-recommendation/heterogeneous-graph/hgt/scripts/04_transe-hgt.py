...
f = open('eval-lpwc-dt/hgt/results/04_eval-hgt-transe.txt', 'w')
sys.stdout = f
...
class Model(torch.nn.Module):
    def __init__(self, out_channels):
        super().__init__()
        self.paper_lin = torch.nn.Linear(128, out_channels)
        self.method_lin = torch.nn.Linear(128, out_channels)
        self.dataset_lin = torch.nn.Linear(128, out_channels)
